...
function focusOnSpatialObject(a){var b=currentSpatialObjects[a];if(!b)return $.UIkit.notify({message:"Spatial Object <span style='color:red'>"+a+"</span> not in the Map!!",status:"warning",timeout:ApplicationOptions.constants.NOTIFY_WARNING_TIMEOUT,pos:"top-center"}),!1;clearFocus();selectedSpatialObject=a;map.setView(b.marker.getLatLng(),17,{animate:!0});$("#objectInfo").find("#objectInfoId").html(selectedSpatialObject);b.marker.openPopup();toggled||($("#objectInfo").animate({width:"toggle"},100),
